...
//   cache: true
// });
_getScript("http://weblog.ujipin.com/weblog.js?act=pv&user_id="+user_id+"&user_name="+user_name+"&refer="+refer+"&lpwin="+lpwin+"&channel_refer="+channel_refer+"&guid="+guid+"&uv_track="+uv_track+"&screen_height="+screen_height+"&screen_width="+screen_width+"&user_type="+user_type);
//页面加载完毕执行方法
	...
	for(var i=0;i<obj.length;i++)
	{
		...
		if(reg_track.test(obj[i].className) && obj[i].href.indexOf('track=') <= 0)
		{
			...
			obj[i].onclick = function(){
				...
				_getScript("http://weblog.ujipin.com/weblog.js?act=click&user_id="+user_id+"&user_name="+user_name+"&lpwin="+lpwin+"&channel_refer="+channel_refer+"&click_time="+click_time+"&track="+track+"&go_url="+go_url+"&guid="+guid+"&uv_track="+uv_track);
			}
		}
	}
}
